...
@DisplayName("UrgentRuleStrategy")
class UrgentRuleStrategyTest {

    private UrgentRuleStrategy strategy;
    ...
    class GetMaxDurationMinutesTests {
        ...
        @Test
        @DisplayName("returns exactly 30 minutes")
        void returnsExactly30Minutes() {
            assertEquals(30, strategy.getMaxDurationMinutes());
        }
    }
