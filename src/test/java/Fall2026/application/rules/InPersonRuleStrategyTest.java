...
@DisplayName("InPersonRuleStrategy")
class InPersonRuleStrategyTest {

    private InPersonRuleStrategy strategy;
    private LocalDate testDate;

    @BeforeEach
    void setUp() {
        strategy = new InPersonRuleStrategy();
    ...
    class ValidateTests {
        ...
        void passesAtMaxDuration() {
            ...
            Appointment appointment = new Appointment(slot, "desc", 1, AppointmentType.IN_PERSON);
        ...
        void throwsWhenCapacityExceedsMax() {
            ...
            Appointment appointment = new Appointment(slot, "desc", 2, AppointmentType.IN_PERSON);
